...
console.log(p1);
console.log( p1.firstName );//diff ways of accessing the data
console.log( p1["lastName"] );
console.log( p1.name() );

//calling the protoype to add a fct
//have to call the OG fct to add more stuff to it
Person.prototype.print = function() { // ajout d'une méthode via le prototype
	console.log( this.name() + " " + this.pronoun );
}

console.log(p1); //pointing towards the OG so we will see stuff in __proto__
console.log(Person.prototype); //pointing only at prototype so the added methods only+const
var proto1 = Object.getPrototypeOf(p1); //this gets the protoype of the given obj ==uski OG referenc
console.log(proto1);
Object.getPrototypeOf(proto1).foo = "bar";
console.log(Object.getPrototypeOf(proto1).foo);
